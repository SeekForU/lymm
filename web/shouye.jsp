...
<div class="banner">
    <div class="Rdaohang">
        <div class="Rdaohang1"><a rel="nofollow"
                                  href="http://wpa.qq.com/msgrd?v=3&amp;uin=2439145710&amp;site=qq&amp;menu=yes"><img
                src="img/4.png"></a></div>
    ...
    <div class="bannerC">
        ...
        <div class="bannerCR">
            ...
            <div class="bannerCR2">
                ...
                <div class="bannerCR11"><a href="html/chanhouhuifu.html"><img src="img/chanhouhuifu.png"></a></div>
            </div>
            <div class="bannerCR2">
                <%--long ago--%>
                <%--<div class="bannerCR11"><a href="html/yuesao.html"><img src="img/jinpaiyuesao.png"></a></div>--%>
                <%--new--%>
                <div class="bannerCR11"><a href="test/info.html"><img src="img/jinpaiyuesao.png"></a></div>
                <div class="bannerCR11"><a href="html/muyingyongpin.html"><img src="img/yingerzaojiao.png"></a></div>
            </div>
...
<div class="zongti">
    <div class="zongtiC">
        <div class="zongtiCL">
            <div class="zongtiCL1">
                <div class="zongtiCL1L"><h3>孕期饮食的22大注意事项</h3>
                    <p><a href="#">孕期摄入的食物品种应强调多样化，孕妇机体代谢加速，糖分利用增加，热量需要比孕早期明显增加，需要补充多种营养元素，例如蛋白质、维生素、钙、铁、碘等。同时要根据不同的孕期状况进行膳食调整。</a>
                    </p></div>
                <div class="zongtiCL1R"><img src="img/lingshi.png"></div>
            </div>
            <div class="zongtiCL2">
            ...
            <div class="zongtiCL2">
                <div class="zongtiCL2L"><img src="img/3gedian.png"></div>
                <div><a href="#">让准妈手脚不冰冷的营养食谱 手脚冰冷可能是因为造血不足...</a></div>
            </div>
            <div class="zongtiCL2B"><img src="img/jiange_line.png"></div>
            <div class="zongtiCL2">
                <div class="zongtiCL2L"><img src="img/3gedian.png"></div>
                <div><a href="#">孕期准妈妈补钙的家常菜做法 孕妈补钙可以摄取奶及奶制品...</a></div>
            </div>
            <div class="zongtiCL2B"><img src="img/jiange_line.png"></div>
        </div>
        ...
        <div class="zongtiCR">
            ...
            <div class="zongtiCR1R">
                <div class="zongtiCL2L"><img src="img/3gedian.png"></div>
                <div><a href="#">要想宝宝颜值高 孕妈坚持这样做</a></div>
            </div>
            <div class="zongtiCL2B1"><img src="img/taijiao_line.png"></div>

            <div class="zongtiCR1R">
                <div class="zongtiCL2L"><img src="img/3gedian.png"></div>
                <div><a href="#">最另类的音乐胎教方式</a></div>
            </div>
            <div class="zongtiCL2B1"><img src="img/taijiao_line.png"></div>

            <div class="zongtiCR1R">
                <div class="zongtiCL2L"><img src="img/3gedian.png"></div>
                <div><a href="#">胎教新法-对话语言胎教</a></div>
            </div>
            <div class="zongtiCL2B1"><img src="img/taijiao_line.png"></div>

            <div class="zongtiCR1R">
                <div class="zongtiCL2L"><img src="img/3gedian.png"></div>
                <div><a href="#">胎教与胎儿的“思维路线”</a></div>
            </div>
            <div class="zongtiCL2B1"><img src="img/taijiao_line.png"></div>
        </div>
    </div>
    ...
    <div class="table2">
        <table width="1000" border="0">
            <tr>
                <td width="460">
                    <div>
                        <div class="Zleft"><img src="img/shouye_03 (2).png" width="175" height="79"/></div>
                ...
                <td width="491">
                    <div>
                        <div class="Zleft"><img src="img/shouye_05 (2).png" width="147" height="79"/></div>
                        <div class="Zright"><a href="#"><img src="img/xiangq_06.png" width="45" height="18"/></a></div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td rowspan="6">
                    <h4>六六妈</h4>
                    <p>
                        20多天一转眼就过去了，一转眼明天就回家了，浣云石朋友总跟我说月子是最难熬的，没想到这一个月在我赶来显得过的如此之快，这要感谢喜悦科学的月子方式，才让在保持心情愉快的同时又能很好的恢复身体</p>
                    <p><img src="img/shouyex_16.png" width="487" height="14"/></p>
                    <h4>小曼妈</h4>
                    <p>
                        女儿取名叫小曼，是希望她一切都恰到好处，刚刚好，什么都诚心如意。出生以来就觉着这姑娘运气好，能遇上一群可爱、善良又勤劳的人，照顾她度过人生中的第一个月。原来以为月子会无聊到爆，没想到这20多天眨眼就过。沾女儿的光，遇见你小云阿姨，遇见莫医生。</p>
                </td>
            </tr>
            <tr>
                <td height="43"><p><img src="img/shouye_13 (2).png" width="9" height="14"/><a href="#">坐月子期间可以下床活动吗？</a>
                </p>
                    <img src="img/shouyex_16.png" width="487" height="6"/>
                </td>
            </tr>
            <tr>
                <td height="43"><p><img src="img/shouye_13 (2).png" width="9" height="14"/><a
                        href="#">产妇坐月子生活上有什么要注意的？</a></p>
                    <img src="img/shouyex_16.png" width="487" height="6"/></td>
            </tr>
            <tr>
                <td height="43"><p><img src="img/shouye_13 (2).png" width="9" height="14"/><a href="#">坐月子开空调要注意什么？</a>
                </p>
                    <img src="img/shouyex_16.png" width="487" height="6"/>
                </td>
            </tr>
            <tr>
                <td height="43"><p><img src="img/shouye_13 (2).png" width="9" height="14"/><a href="#">新生儿出现这十五种情况，妈咪不必慌张</a>
                </p>
                    <img src="img/shouyex_16.png" width="487" height="6"/>
                </td>
            </tr>
            <tr>
                <td height="43"><p><img src="img/shouye_13 (2).png" width="9" height="14"/><a href="#">秋季剖腹产和会阴侧切坐月子要注意什么？</a>
                </p>
                    <img src="img/shouyex_16.png" width="487" height="6"/>
                </td>
            </tr>
